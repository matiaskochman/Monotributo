        ...
        <div id="showMonotributista">
	        <g:set var="monotributista" value="${monotributistaInstance.id}" scope="session" />
            ...
            <div class="buttons">
                <g:formRemote name="edit" url="[controller:'monotributista', action:'edit2']" update="showMonotributista">
                ...
                <g:formRemote name="delete" url="[controller:'monotributista', action:'delete2']" update="showMonotributista">
                    <g:hiddenField name="id" value="${monotributistaInstance?.id}" />
                ...
                <g:formRemote name="list" url="[controller:'monotributista', action:'list2']" update="showMonotributista">
