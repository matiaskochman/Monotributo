                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: areaInstance, field: 'tipo', 'errors')}">
                                    <g:textField name="tipo" value="${areaInstance?.tipo}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="area"><g:message code="area.area.label" default="Area Padre" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: areaInstance, field: 'areaPadre', 'errors')}">
                                    <g:select name="area.id" from="${monotributo.Area.list()}" optionKey="id" optionValue="descripcion" value="${areaInstance?.areaPadre?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
